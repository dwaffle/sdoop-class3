...
class Button {
    ...
    isPressed:boolean = false; //Represents the pressed -state- of the button.

    protected interval:any;

    constructor( readonly emblem:string, private remote:Remote){  //Once we've created a button, that button won't change.
